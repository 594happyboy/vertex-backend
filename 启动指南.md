...
1. 打开Cursor编辑器
2. 确保你在项目根目录：`E:\SpringProjects\vertex-backend`
3. 在Cursor中打开终端：
   - 方式1：菜单栏 → 终端 → 新建终端
   - 方式2：快捷键 `Ctrl + ~`
   - 方式3：快捷键 `Ctrl + Shift + `` ` ``
...
```
NAME                STATUS              PORTS
vertex-mysql        running             0.0.0.0:3306->3306/tcp
vertex-redis        running             0.0.0.0:6379->6379/tcp
vertex-minio        running             0.0.0.0:9000-9001->9000-9001/tcp
```
...
2025-10-09 15:30:25 [main] INFO  c.z.v.VertexBackendApplication - Starting VertexBackendApplication...
...
2025-10-09 15:30:32 [main] INFO  o.s.b.w.e.t.TomcatWebServer - Tomcat started on port(s): 8080 (http)
2025-10-09 15:30:32 [main] INFO  c.z.v.VertexBackendApplication - Started VertexBackendApplication in 7.234 seconds
```

✅ **如果看到"Started VertexBackendApplication"，说明应用启动成功！**
...
3. 删除数据卷：`docker volume rm vertex-backend_mysql-data`
